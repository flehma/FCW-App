  ...
  <div class="p-2">
    ...
    <div class="flex mt-2 mb-4 flex-row flex-wrap items-center gap-2">
      <RouterLink to="/strafen/add">
        <button
          class="p-2 px-3 bg-blue-500 text-white rounded hover:bg-blue-400 transition-colors whitespace-nowrap text-sm"
        >
          Hinzufügen
        </button>
      </RouterLink>
      ...
      <RouterLink to="/strafen">
        <button
          class="inline-flex items-center border border-blue-300 px-3 py-1.5 rounded-md text-blue-500 hover:bg-blue-50 transition-colors whitespace-nowrap text-sm"
        >
          Zurück
        </button>
      </RouterLink>
        ...
        >
          ...
          <div class="px-3 py-3 flex items-center justify-between w-full">
            ...
            <div
              ...
              class="font-semibold text-center p-1 rounded bg-blue-500 w-[60px] h-[60px] text-white ml-2 shrink-0"
            >
            ...
            <div
              v-else
              class="font-semibold text-center p-1 rounded bg-blue-500 w-[60px] text-white ml-2 shrink-0"
            >
              {{ strafe?.wert_geld }}€
            </div>
          </div>
